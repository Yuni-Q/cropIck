...
import { StyledButton, StyledCategoryWrapper, StyledNavButton, StyledSearchNavWrapper } from '../components/MainSearch';
  ...
  return (
    <StyledWrapper>
      ...
      <StyledCategoryWrapper>
        ...
        <StyledButton className="m-0 ml-7"><a>검색하기</a></StyledButton>
      </StyledCategoryWrapper>
      <div>
        ...
        <Main>
          ...
          <div className="ml-16">
            ...
            <div style={{ textAlign: 'center' }}>1/3</div>
          </div>
        </Main>
        <Info>
            <InfoTitle>
